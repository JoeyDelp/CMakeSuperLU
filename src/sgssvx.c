...
void
sgssvx(superlu_options_t *options, SuperMatrix *A, long long *perm_c, long long *perm_r,
       long long *etree, char *equed, float *R, float *C,
       ...
       GlobalLU_t *Glu, mem_usage_t *mem_usage, SuperLUStat_t *stat, long long *info )
{
    ...
    long long       colequ, equil, nofact, notran, rowequ, permc_spec;
    trans_t   trant;
    char      norm[1];
    long long       i, j, info1;
