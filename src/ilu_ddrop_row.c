...
extern void dswap_(long long *, double [], long long *, double [], long long *);
extern void daxpy_(long long *, double *, double [], long long *, double [], long long *);
