...
/* Internal prototypes */
void  *zexpand (long long *, MemType,long long, long long, GlobalLU_t *);
long long   zLUWorkInit (long long, long long, long long, long long **, doublecomplex **, GlobalLU_t *);
void  copy_mem_doublecomplex (long long, void *, void *);
void  zStackCompress (GlobalLU_t *);
void  zSetupSpace (void *, long long, GlobalLU_t *);
void  *zuser_malloc (long long, long long, GlobalLU_t *);
void  zuser_free (long long, long long, GlobalLU_t *);
 ...
 */
void zSetupSpace(void *work, long long lwork, GlobalLU_t *Glu)
{
    if ( lwork == 0 ) {
...
void *zuser_malloc(long long bytes, long long which_end, GlobalLU_t *Glu)
{
    void *buf;
...
void zuser_free(long long bytes, long long which_end, GlobalLU_t *Glu)
{
    if ( which_end == HEAD ) {
	Glu->stack.top1 -= bytes;
    } else {
 ...
 * </pre>
 */
long long zQuerySpace(SuperMatrix *L, SuperMatrix *U, mem_usage_t *mem_usage)
{
    SCformat *Lstore;
    NCformat *Ustore;
 ...
 * </pre>
 */
long long ilu_zQuerySpace(SuperMatrix *L, SuperMatrix *U, mem_usage_t *mem_usage)
{
    SCformat *Lstore;
    NCformat *Ustore;
 ...
 */
long long
zLUMemInit(fact_t fact, void *work, long long lwork, long long m, long long n, long long annz,
	  long long panel_size, double fill_ratio, SuperMatrix *L, SuperMatrix *U,
          GlobalLU_t *Glu, long long **iwork, doublecomplex **dwork)
{
	...
	if ( Glu->MemModel == SYSTEM ) {
	    ...
	    xsup   = (long long *)zuser_malloc((n+1) * iword, HEAD, Glu);
	    supno  = (long long *)zuser_malloc((n+1) * iword, HEAD, Glu);
	    xlsub  = (long long *)zuser_malloc((n+1) * iword, HEAD, Glu);
	    xlusup = (long long *)zuser_malloc((n+1) * iword, HEAD, Glu);
	    xusub  = (long long *)zuser_malloc((n+1) * iword, HEAD, Glu);
	}

	lusup = (doublecomplex *) zexpand( &nzlumax, LUSUP, 0, 0, Glu );
	ucol  = (doublecomplex *) zexpand( &nzumax, UCOL, 0, 0, Glu );
	lsub  = (long long *)    zexpand( &nzlmax, LSUB, 0, 0, Glu );
	usub  = (long long *)    zexpand( &nzumax, USUB, 0, 1, Glu );
...
long long
zLUWorkInit(long long m, long long n, long long panel_size, long long **iworkptr, 
            doublecomplex **dworkptr, GlobalLU_t *Glu)
{
	...
	*iworkptr = (long long *) zuser_malloc(isize, TAIL, Glu);
    if ( ! *iworkptr ) {
 ...
 */
void
zSetRWork(long long m, long long panel_size, doublecomplex *dworkptr,
 ...
 */
void zLUWorkFree(long long *iwork, doublecomplex *dwork, GlobalLU_t *Glu)
{
    if ( Glu->MemModel == SYSTEM ) {
	SUPERLU_FREE (iwork);
	SUPERLU_FREE (dwork);
...
void
copy_mem_doublecomplex(long long howmany, void *old, void *new)
{
 ...
 */
void
zallocateA(long long n, long long nnz, doublecomplex **a, long long **asub, long long **xa)
{
...
doublecomplex *doublecomplexMalloc(long long n)
{
    doublecomplex *buf;
...
doublecomplex *doublecomplexCalloc(long long n)
{
    doublecomplex *buf;
    register long long i;
    doublecomplex zero = {0.0, 0.0};
...
long long zmemory_usage(const long long nzlmax, const long long nzumax, 
