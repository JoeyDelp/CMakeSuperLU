...
static long long sDumpLine(FILE *fp)
{
...
static long long sParseIntFormat(char *buf, long long *num, long long *size)
{
    char *tmp;
...
static long long sParseFloatFormat(char *buf, long long *num, long long *size)
{
    char *tmp, *period;
...
static long long sReadValues(FILE *fp, long long n, float *destination, long long perline,
        long long persize)
{
 ...
 */
static void
FormFullA(long long n, long long *nonz, float **nzval, long long **rowind, long long **colptr)
{
...
void
sreadrb(long long *nrow, long long *ncol, long long *nonz,
