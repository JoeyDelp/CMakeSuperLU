...
extern void zswap_(long long *, doublecomplex [], long long *, doublecomplex [], long long *);
extern void zaxpy_(long long *, doublecomplex *, doublecomplex [], long long *, doublecomplex [], long long *);
extern void zcopy_(long long *, doublecomplex [], long long *, doublecomplex [], long long *);
extern double dzasum_(long long *, doublecomplex *, long long *);
extern double dznrm2_(long long *, doublecomplex *, long long *);
extern double dnrm2_(long long *, double [], long long *);
extern void dcopy_(long long *, double [], long long *, double [], long long *);
extern long long izamax_(long long *, doublecomplex [], long long *);
