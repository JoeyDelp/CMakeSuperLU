...
long long cParseIntFormat(char *buf, long long *num, long long *size)
{
    char *tmp;
...
long long cParseFloatFormat(char *buf, long long *num, long long *size)
{
    char *tmp, *period;
...
long long cReadValues(FILE *fp, long long n, complex *destination, long long perline, long long persize)
{
...
void
creadhb(FILE *fp, long long *nrow, long long *ncol, long long *nonz,
