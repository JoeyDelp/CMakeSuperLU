...
long long sParseIntFormat(char *buf, long long *num, long long *size)
{
    char *tmp;
...
long long sParseFloatFormat(char *buf, long long *num, long long *size)
{
    char *tmp, *period;
...
long long sReadValues(FILE *fp, long long n, float *destination, long long perline, long long persize)
{
...
void
sreadhb(FILE *fp, long long *nrow, long long *ncol, long long *nonz,
