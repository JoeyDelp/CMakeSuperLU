...
long long
sp_cgemm(char *transa, char *transb, long long m, long long n, long long k, 
         complex alpha, SuperMatrix *A, complex *b, long long ldb, 
         complex beta, complex *c, long long ldc)
{
