...
/* Internal prototypes */
void  *sexpand (long long *, MemType,long long, long long, GlobalLU_t *);
long long   sLUWorkInit (long long, long long, long long, long long **, float **, GlobalLU_t *);
void  copy_mem_float (long long, void *, void *);
void  sStackCompress (GlobalLU_t *);
void  sSetupSpace (void *, long long, GlobalLU_t *);
void  *suser_malloc (long long, long long, GlobalLU_t *);
void  suser_free (long long, long long, GlobalLU_t *);
 ...
 */
void sSetupSpace(void *work, long long lwork, GlobalLU_t *Glu)
{
    if ( lwork == 0 ) {
...
void *suser_malloc(long long bytes, long long which_end, GlobalLU_t *Glu)
{
    void *buf;
...
void suser_free(long long bytes, long long which_end, GlobalLU_t *Glu)
{
    if ( which_end == HEAD ) {
	Glu->stack.top1 -= bytes;
    } else {
 ...
 * </pre>
 */
long long sQuerySpace(SuperMatrix *L, SuperMatrix *U, mem_usage_t *mem_usage)
{
    SCformat *Lstore;
    NCformat *Ustore;
 ...
 * </pre>
 */
long long ilu_sQuerySpace(SuperMatrix *L, SuperMatrix *U, mem_usage_t *mem_usage)
{
    SCformat *Lstore;
    NCformat *Ustore;
 ...
 */
long long
sLUMemInit(fact_t fact, void *work, long long lwork, long long m, long long n, long long annz,
	  long long panel_size, float fill_ratio, SuperMatrix *L, SuperMatrix *U,
          GlobalLU_t *Glu, long long **iwork, float **dwork)
{
	...
	if ( Glu->MemModel == SYSTEM ) {
	    ...
	    xsup   = (long long *)suser_malloc((n+1) * iword, HEAD, Glu);
	    supno  = (long long *)suser_malloc((n+1) * iword, HEAD, Glu);
	    xlsub  = (long long *)suser_malloc((n+1) * iword, HEAD, Glu);
	    xlusup = (long long *)suser_malloc((n+1) * iword, HEAD, Glu);
	    xusub  = (long long *)suser_malloc((n+1) * iword, HEAD, Glu);
	}

	lusup = (float *) sexpand( &nzlumax, LUSUP, 0, 0, Glu );
	ucol  = (float *) sexpand( &nzumax, UCOL, 0, 0, Glu );
	lsub  = (long long *)    sexpand( &nzlmax, LSUB, 0, 0, Glu );
	usub  = (long long *)    sexpand( &nzumax, USUB, 0, 1, Glu );
...
long long
sLUWorkInit(long long m, long long n, long long panel_size, long long **iworkptr, 
            float **dworkptr, GlobalLU_t *Glu)
{
	...
	*iworkptr = (long long *) suser_malloc(isize, TAIL, Glu);
    if ( ! *iworkptr ) {
 ...
 */
void
sSetRWork(long long m, long long panel_size, float *dworkptr,
 ...
 */
void sLUWorkFree(long long *iwork, float *dwork, GlobalLU_t *Glu)
{
    if ( Glu->MemModel == SYSTEM ) {
	SUPERLU_FREE (iwork);
	SUPERLU_FREE (dwork);
...
void
copy_mem_float(long long howmany, void *old, void *new)
{
 ...
 */
void
sallocateA(long long n, long long nnz, float **a, long long **asub, long long **xa)
{
...
long long smemory_usage(const long long nzlmax, const long long nzumax, 
