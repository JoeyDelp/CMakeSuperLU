...
long long zParseIntFormat(char *buf, long long *num, long long *size)
{
    char *tmp;
...
long long zParseFloatFormat(char *buf, long long *num, long long *size)
{
    char *tmp, *period;
...
long long zReadValues(FILE *fp, long long n, doublecomplex *destination, long long perline, long long persize)
{
...
void
zreadhb(FILE *fp, long long *nrow, long long *ncol, long long *nonz,
