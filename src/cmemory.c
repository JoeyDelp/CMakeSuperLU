...
/* Internal prototypes */
void  *cexpand (long long *, MemType,long long, long long, GlobalLU_t *);
long long   cLUWorkInit (long long, long long, long long, long long **, complex **, GlobalLU_t *);
void  copy_mem_complex (long long, void *, void *);
void  cStackCompress (GlobalLU_t *);
void  cSetupSpace (void *, long long, GlobalLU_t *);
void  *cuser_malloc (long long, long long, GlobalLU_t *);
void  cuser_free (long long, long long, GlobalLU_t *);
 ...
 */
void cSetupSpace(void *work, long long lwork, GlobalLU_t *Glu)
{
    if ( lwork == 0 ) {
...
void *cuser_malloc(long long bytes, long long which_end, GlobalLU_t *Glu)
{
    void *buf;
...
void cuser_free(long long bytes, long long which_end, GlobalLU_t *Glu)
{
    if ( which_end == HEAD ) {
	Glu->stack.top1 -= bytes;
    } else {
 ...
 * </pre>
 */
long long cQuerySpace(SuperMatrix *L, SuperMatrix *U, mem_usage_t *mem_usage)
{
    SCformat *Lstore;
    NCformat *Ustore;
 ...
 * </pre>
 */
long long ilu_cQuerySpace(SuperMatrix *L, SuperMatrix *U, mem_usage_t *mem_usage)
{
    SCformat *Lstore;
    NCformat *Ustore;
 ...
 */
long long
cLUMemInit(fact_t fact, void *work, long long lwork, long long m, long long n, long long annz,
	  long long panel_size, float fill_ratio, SuperMatrix *L, SuperMatrix *U,
          GlobalLU_t *Glu, long long **iwork, complex **dwork)
{
	...
	if ( Glu->MemModel == SYSTEM ) {
	    ...
	    xsup   = (long long *)cuser_malloc((n+1) * iword, HEAD, Glu);
	    supno  = (long long *)cuser_malloc((n+1) * iword, HEAD, Glu);
	    xlsub  = (long long *)cuser_malloc((n+1) * iword, HEAD, Glu);
	    xlusup = (long long *)cuser_malloc((n+1) * iword, HEAD, Glu);
	    xusub  = (long long *)cuser_malloc((n+1) * iword, HEAD, Glu);
	}

	lusup = (complex *) cexpand( &nzlumax, LUSUP, 0, 0, Glu );
	ucol  = (complex *) cexpand( &nzumax, UCOL, 0, 0, Glu );
	lsub  = (long long *)    cexpand( &nzlmax, LSUB, 0, 0, Glu );
	usub  = (long long *)    cexpand( &nzumax, USUB, 0, 1, Glu );
...
long long
cLUWorkInit(long long m, long long n, long long panel_size, long long **iworkptr, 
            complex **dworkptr, GlobalLU_t *Glu)
{
	...
	*iworkptr = (long long *) cuser_malloc(isize, TAIL, Glu);
    if ( ! *iworkptr ) {
 ...
 */
void
cSetRWork(long long m, long long panel_size, complex *dworkptr,
 ...
 */
void cLUWorkFree(long long *iwork, complex *dwork, GlobalLU_t *Glu)
{
    if ( Glu->MemModel == SYSTEM ) {
	SUPERLU_FREE (iwork);
	SUPERLU_FREE (dwork);
...
void
copy_mem_complex(long long howmany, void *old, void *new)
{
 ...
 */
void
callocateA(long long n, long long nnz, complex **a, long long **asub, long long **xa)
{
...
complex *complexMalloc(long long n)
{
    complex *buf;
...
complex *complexCalloc(long long n)
{
    complex *buf;
    register long long i;
    complex zero = {0.0, 0.0};
...
long long cmemory_usage(const long long nzlmax, const long long nzumax, 
