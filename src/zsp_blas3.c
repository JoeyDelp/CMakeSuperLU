...
long long
sp_zgemm(char *transa, char *transb, long long m, long long n, long long k, 
         doublecomplex alpha, SuperMatrix *A, doublecomplex *b, long long ldb, 
         doublecomplex beta, doublecomplex *c, long long ldc)
{
